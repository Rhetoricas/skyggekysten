...
export function genererUndergrund(biome: Biome | string) {
    ...
    if (biome === 'bandit') {
        ...
        if (terningKast < 50) feltData.skjultLoot = 'diamant';
        else if (terningKast < 80) feltData.skjultGuld = tilfaeldigtTal(5, 10);
        else if (terningKast < 95) feltData.skjultFaelde = true;
