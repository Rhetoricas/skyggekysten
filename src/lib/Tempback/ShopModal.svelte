<script lang="ts">
    ...
    function købVare(id: string) {
        ...
        if (spilTilstand.guldTotal >= pris) {
            ...
            spilTilstand.logBesked = `Købmanden afviser dig. Du mangler ${pris - spilTilstand.guldTotal} guld.`;
        }
    }
</script>
...
<div class="shop-overlay">
    <div class="shop-content">
        ...
        <p class="shop-desc">Her forsyner du dig med udstyr til den videre rejse gennem tågen.</p>
