...
export const itemDB: Record<string, { id: string; navn: string; type: ItemType; billede: string; pris: number; kanKoebes?: boolean; moveMod?: number; dmgMod?: number; synsMod?: number; energiMod?: number; goldMod?: number; beskrivelse?: string }> = {
    'klude': { id: 'klude', navn: 'Tøj', type: 'tøj', billede: '/inventory/klude.webp', pris: 10, dmgMod: -0.05, beskrivelse: "Giver en smule beskyttelse. Du tager 5% mindre skade." },
    ...
    'dirk': { id: 'dirk', navn: 'Dirk', type: 'værktøj', billede: '/inventory/dirk.webp', pris: 50, kanKoebes: false, beskrivelse: "Tyveværktøj. Kan bruges til indbrud på tomme byfelter." },
    ...
    'stav': { id: 'stav', navn: 'Stav', type: 'våben', billede: '/inventory/stav.webp', pris: 100, beskrivelse: "Kan teleportere dig 4 felter mod øst. Koster base-energi. Feltet aktiveres som normalt. Står du på krystal, viser staven krystalfelter inden for radius 4." },
    'dragestav': { id: 'dragestav', navn: 'Dragestav', type: 'våben', billede: '/inventory/stav_upgr.webp', pris: 300, kanKoebes: false, beskrivelse: "Opgraderet stav. Teleporterer dig 5 felter mod øst og afslører ruten imellem. Hvis den ville sende dig i åbent vand, redder den dig til sidste sikre felt og bliver til en almindelig stav. Står du på krystal, viser den krystalfelter inden for radius 5." },
    ...
    'diamant': { id: 'diamant', navn: 'Diamant', type: 'skat', billede: '/inventory/diamant.webp', pris: 500, beskrivelse: "En sjælden ædelsten til 250-600 guld. Værdien afhænger af størrelsen og sættes, når den findes." },
...
export const tilgaengeligeKarakterer: Karakter[] = [
    { id: 'knight_m', navn: "Ridder", ikon: "/game_faces/knight_m.webp", startMsg: "Rustningen tynger, men beskytter.", startHp: 120, startGuld: 0, startUdstyr: ['svaerd', 'rustning', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 0.9, goldMod: 1.0, fordel: "Mere robust end normalen: 120 HP, 10% mindre skade og rustning fra start.", ulempe: "Rustningen gør bevægelse dyrere. Økonomien starter på nul.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'knight_f', navn: "Skjoldmø", ikon: "/game_faces/knight_f.webp", startMsg: "Rustningen tynger, men beskytter.", startHp: 120, startGuld: 0, startUdstyr: ['svaerd', 'rustning', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 0.9, goldMod: 1.0, fordel: "Rustningen gør nedgravede fælder ufarlige. Slagmark er billigere terræn.", ulempe: "Fældefordelen forsvinder, hvis rustningen forsvinder.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'magician_m', navn: "Troldmand", ikon: "/game_faces/magician_m.webp", startMsg: "Magi beskytter ikke mod mudder.", startHp: 80, startGuld: 0, startUdstyr: ['stav', 'klude', 'livseliksir', 'sovepose'], moveCost: 1, digCost: 8, dmgMod: 1.5, goldMod: 1.0, fordel: "Staven giver store spring mod øst. Livseliksir og sovepose giver nødplan fra start.", ulempe: "Meget skrøbelig: lav HP, 50% mere skade og dyr gravning.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'krystal': -2 } },  
    { id: 'magician_f', navn: "Vølve", ikon: "/game_faces/magician_f.webp", startMsg: "Magi beskytter ikke mod mudder.", startHp: 80, startGuld: 0, startUdstyr: ['stav', 'klude', 'livseliksir', 'sovepose'], moveCost: 1, digCost: 8, dmgMod: 1.5, goldMod: 1.0, fordel: "Krystal er billigere terræn, og staven afslører krystalfelter derfra.", ulempe: "Meget lav fejlmargin: lav HP og 50% mere skade.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'krystal': -2 } },
    { id: 'thief_m', navn: "Tyv", ikon: "/game_faces/thief_m.webp", startMsg: "Hold dig i bevægelse.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.1, fordel: "Dirken åbner for indbrud i tomme byfelter. Starter med 50 guld og sovepose.", ulempe: "Tager 20% mere skade, så tyveruter tåler færre fejl.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    { id: 'thief_f', navn: "Skygge", ikon: "/game_faces/thief_f.webp", startMsg: "Hold dig i bevægelse.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.1, fordel: "Høj energi, +10% guld og billigere banditlejre giver hurtig økonomi.", ulempe: "20% mere skade gør kampe og fælder farligere end for normalen.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    { id: 'explorer_m', navn: "Opdager", ikon: "/game_faces/explorer_m.webp", startMsg: "Du kender terrænet.", startHp: 100, startGuld: 0, startUdstyr: ['skovl', 'klude', 'sovepose'], moveCost: 1, digCost: 3, dmgMod: 1.0, goldMod: 0.9, fordel: "Skovl og billig gravning fra start. Syn 2 giver bedre rutevalg.", ulempe: "10% mindre guldindkomst og ingen våben fra start.", baseEnergi: 7, synsRadius: 2, biomeMod: { 'hule': -2, 'ruin': -2 } },
    { id: 'explorer_f', navn: "Eventyrer", ikon: "/game_faces/explorer_f.webp", startMsg: "Du kender terrænet.", startHp: 100, startGuld: 0, startUdstyr: ['skovl', 'klude', 'sovepose'], moveCost: 1, digCost: 3, dmgMod: 1.0, goldMod: 0.9, fordel: "Syn 2 og billigere huler/ruiner gør udforskning mere kontrolleret.", ulempe: "10% mindre guldindkomst. Du skal grave mere for samme økonomi.", baseEnergi: 7, synsRadius: 2, biomeMod: { 'hule': -2, 'ruin': -2 } },
    { id: 'viking_m', navn: "Viking", ikon: "/game_faces/viking_m.webp", startMsg: "Du starter stærkt, men uden sovepose.", startHp: 140, startGuld: 100, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 0.9, goldMod: 0.9, fordel: "Meget stærk start og bersærkergang efter skade. Slagmark er billigere.", ulempe: "Ingen sovepose og 10% mindre guldindkomst. Styrken skal bære dig mellem helingskilder.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'viking_f', navn: "Valkyrie", ikon: "/game_faces/viking_f.webp", startMsg: "Du starter stærkt, men uden sovepose.", startHp: 140, startGuld: 100, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 0.9, goldMod: 0.9, fordel: "Bersærkergang kan gøre næste energikrævende handling gratis. Slagmark er billigere.", ulempe: "Ingen sovepose og 10% mindre guldindkomst. Du er stærkest, når du kan tåle at blive ramt.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'royal_m', navn: "Hertug", ikon: "/game_faces/royal_m.webp", startMsg: "Du starter med mange penge og intet våben.", startHp: 100, startGuld: 500, startUdstyr: ['flot_toej', 'sovepose'], moveCost: 1, digCost: 10, dmgMod: 1.1, goldMod: 1.2, fordel: "Rigeste start: 500 guld, fint tøj og 20% mere guldindkomst.", ulempe: "Svag basis: lav energi, dyr gravning, 10% mere skade og intet våben.", baseEnergi: 6, synsRadius: 1 },
    { id: 'royal_f', navn: "Dronning", ikon: "/game_faces/royal_f.webp", startMsg: "Du starter med mange penge og intet våben.", startHp: 100, startGuld: 500, startUdstyr: ['flot_toej', 'sovepose'], moveCost: 1, digCost: 10, dmgMod: 1.1, goldMod: 1.2, fordel: "Kan købe en strategi tidligt. Fint tøj gør guldspillet endnu stærkere.", ulempe: "Afhænger af købte løsninger: lav energi, dyr gravning og intet våben.", baseEnergi: 6, synsRadius: 1 },
    { id: 'hunter_m', navn: "Jæger", ikon: "/game_faces/hunter_m.webp", startMsg: "Hold afstand til byttet.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 1.1, goldMod: 1.0, fordel: "Bue, syn 2 og billigere skov gør ham god til planlagte ruter.", ulempe: "90 HP og 10% mere skade. Dårlige træf rammer hårdt.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'hunter_f', navn: "Skytte", ikon: "/game_faces/hunter_f.webp", startMsg: "Hold afstand til byttet.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 1.1, goldMod: 1.0, fordel: "Syn 2 samt billigere skov og blodskov gør farlige ruter lettere at læse.", ulempe: "Mindre robust end normalen: 90 HP og 10% mere skade.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'pirate_m', navn: "Kaptajn", ikon: "/game_faces/pirate_m.webp", startMsg: "Havet tog alt andet.", startHp: 110, startGuld: 150, startUdstyr: ['sabel', 'klude', 'hemmelighed'], moveCost: 1, digCost: 5, dmgMod: 1.0, goldMod: 1.2, fordel: "Starter med sabel, skattekort, 150 guld og 20% mere guldindkomst.", ulempe: "Ingen sovepose. Ruten skal finansiere din overlevelse.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'hav': -3, 'soe': -1 } },
    { id: 'pirate_f', navn: "Korsar", ikon: "/game_faces/pirate_f.webp", startMsg: "Havet tog alt andet.", startHp: 110, startGuld: 150, startUdstyr: ['sabel', 'klude', 'hemmelighed'], moveCost: 1, digCost: 5, dmgMod: 1.0, goldMod: 1.2, fordel: "Hav og sø er billigere terræn. Skattekort giver tidlig kistejagt.", ulempe: "Ingen sovepose. Du skal finde eller købe din heling undervejs.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'hav': -3, 'soe': -1 } },
    { id: 'dwarf_m', navn: "Dværg", ikon: "/game_faces/dwarf_m.webp", startMsg: "Du graver effektivt, men bevæger dig langsomt.", startHp: 130, startGuld: 80, startUdstyr: ['skovl', 'oekse', 'klude'], moveCost: 1.5, digCost: 2, dmgMod: 1.0, goldMod: 1.1, fordel: "Stærk graveøkonomi: skovl fra start, gravning for 2 energi og +10% guld.", ulempe: "Langsom på almindelige skridt og ingen sovepose.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'bjerg': -3, 'krystal': -2 } },
    { id: 'dwarf_f', navn: "Graver", ikon: "/game_faces/dwarf_f.webp", startMsg: "Du graver effektivt, men bevæger dig langsomt.", startHp: 130, startGuld: 80, startUdstyr: ['skovl', 'oekse', 'klude'], moveCost: 1.5, digCost: 2, dmgMod: 1.0, goldMod: 1.1, fordel: "Bjerg og krystal er billigere, og gravning giver +10% guld. Stærkest, når ruten går gennem graveområder.", ulempe: "Langsom uden for sine terræner og uden sovepose.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'bjerg': -3, 'krystal': -2 } },
    { id: 'orc_m', navn: "Ork", ikon: "/game_faces/orc_m.webp", startMsg: "Du starter med meget HP, kølle og lav guldindkomst.", startHp: 150, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "Mest rå styrke: 150 HP, 20% mindre skade og kølle fra start.", ulempe: "20% mindre guldindkomst og ingen sovepose. Økonomien er svag uden smadring.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'orc_f', navn: "Kriger", ikon: "/game_faces/orc_f.webp", startMsg: "Du starter med meget HP, kølle og lav guldindkomst.", startHp: 150, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "Køllen åbner for smadring. Slagmark er billigere terræn.", ulempe: "Smadring skræmmer naboers handlende. 20% mindre guldindkomst.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'joker_m', navn: "Joker", ikon: "/game_faces/joker_m.webp", startMsg: "Held er en strategi.", startHp: 50, startGuld: 1, startUdstyr: ['kniv'], moveCost: 1, digCost: 5, dmgMod: 2.0, goldMod: 1.5, fordel: "Største økonomiske bonus: syn 2 og +50% guldindkomst.", ulempe: "Ekstremt skrøbelig: 50 HP og dobbelt skade.", baseEnergi: 7, synsRadius: 2 },
    { id: 'joker_f', navn: "Harlekin", ikon: "/game_faces/joker_f.webp", startMsg: "Held er en strategi.", startHp: 50, startGuld: 1, startUdstyr: ['kniv'], moveCost: 1, digCost: 5, dmgMod: 2.0, goldMod: 1.5, fordel: "Bedst til vilde highscore-ruter: syn 2 og +50% på alt guld.", ulempe: "Næsten ingen sikkerhed: 50 HP, 1 guld og dobbelt skade.", baseEnergi: 7, synsRadius: 2 }
];
