...
export const tilgaengeligeKarakterer: Karakter[] = [
    { id: 'knight_m', navn: "Ridder", ikon: "/game_faces/knight_m.webp", startMsg: "Rustningen tynger, men beskytter.", startHp: 120, startGuld: 0, startUdstyr: ['svaerd', 'rustning', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 0.9, goldMod: 1.0, fordel: "Panser, sværd og disciplin. Nedgravede fælder preller af, når rustningen sidder på.", ulempe: "Tung som en dom: hvert skridt koster mere energi.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'knight_f', navn: "Skjoldmø", ikon: "/game_faces/knight_f.webp", startMsg: "Rustningen tynger, men beskytter.", startHp: 120, startGuld: 0, startUdstyr: ['svaerd', 'rustning', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 0.9, goldMod: 1.0, fordel: "Panser, sværd og disciplin. Nedgravede fælder preller af, når rustningen sidder på.", ulempe: "Tung som en dom: hvert skridt koster mere energi.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'magician_m', navn: "Troldmand", ikon: "/game_faces/magician_m.webp", startMsg: "Magi beskytter ikke mod mudder.", startHp: 80, startGuld: 0, startUdstyr: ['stav', 'klude', 'livseliksir', 'sovepose'], moveCost: 1, digCost: 8, dmgMod: 1.5, goldMod: 1.0, fordel: "Stav, eliksir og sovepose. Kan snyde afstand, ulykker og en del sund fornuft.", ulempe: "Glasben med hat: starter uden guld og tager +50% skade.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'krystal': -2 } },  
    ...
    { id: 'thief_m', navn: "Tyv", ikon: "/game_faces/thief_m.webp", startMsg: "Hold dig i bevægelse.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.1, fordel: "Kniv, dirk og hurtige fingre. Byer og markeder drypper ekstra mønter.", ulempe: "Når planen larmer, gør slagene ekstra ondt.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    { id: 'thief_f', navn: "Skygge", ikon: "/game_faces/thief_f.webp", startMsg: "Hold dig i bevægelse.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.1, fordel: "Kniv, dirk og hurtige fingre. Byer og markeder drypper ekstra mønter.", ulempe: "Når planen larmer, gør slagene ekstra ondt.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    { id: 'explorer_m', navn: "Udforsker", ikon: "/game_faces/explorer_m.webp", startMsg: "Du kender terrænet.", startHp: 100, startGuld: 0, startUdstyr: ['skovl', 'klude', 'sovepose'], moveCost: 1, digCost: 3, dmgMod: 1.0, goldMod: 0.9, fordel: "Ser længere, graver billigt og starter med skovl. Kortet åbner sig tidligt.", ulempe: "Ingen våben fra start. Eventyrlyst er ikke et skjold.", baseEnergi: 7, synsRadius: 2, biomeMod: { 'hule': -2, 'ruin': -2 } },
    { id: 'explorer_f', navn: "Eventyrer", ikon: "/game_faces/explorer_f.webp", startMsg: "Du kender terrænet.", startHp: 100, startGuld: 0, startUdstyr: ['skovl', 'klude', 'sovepose'], moveCost: 1, digCost: 3, dmgMod: 1.0, goldMod: 0.9, fordel: "Ser længere, graver billigt og starter med skovl. Kortet åbner sig tidligt.", ulempe: "Ingen våben fra start. Eventyrlyst er ikke et skjold.", baseEnergi: 7, synsRadius: 2, biomeMod: { 'hule': -2, 'ruin': -2 } },
    { id: 'viking_m', navn: "Viking", ikon: "/game_faces/viking_m.webp", startMsg: "Du starter stærkt, men uden sovepose.", startHp: 150, startGuld: 100, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 0.9, goldMod: 1.0, fordel: "150 HP, økse og bersærkerben: første store skade hver dag kan give et gratis skridt.", ulempe: "Ingen sovepose. Hvile er for folk med bedre logistik.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    ...
    { id: 'royal_m', navn: "Hertug", ikon: "/game_faces/royal_m.webp", startMsg: "Du starter med mange penge og intet våben.", startHp: 100, startGuld: 500, startUdstyr: ['flot_toej', 'sovepose'], moveCost: 1, digCost: 10, dmgMod: 1.1, goldMod: 1.2, fordel: "500 guld, fint tøj og næse for profit. Butikker elsker dig, indtil de ikke gør.", ulempe: "Ingen våben, dyr gravning og alt for meget at miste.", baseEnergi: 6, synsRadius: 1 },
    { id: 'royal_f', navn: "Hertuginde", ikon: "/game_faces/royal_f.webp", startMsg: "Du starter med mange penge og intet våben.", startHp: 100, startGuld: 500, startUdstyr: ['flot_toej', 'sovepose'], moveCost: 1, digCost: 10, dmgMod: 1.1, goldMod: 1.2, fordel: "500 guld, fint tøj og næse for profit. Butikker elsker dig, indtil de ikke gør.", ulempe: "Ingen våben, dyr gravning og alt for meget at miste.", baseEnergi: 6, synsRadius: 1 },
    { id: 'hunter_m', navn: "Jæger", ikon: "/game_faces/hunter_m.webp", startMsg: "Hold afstand til byttet.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 1.1, goldMod: 1.0, fordel: "Bue og skarpt blik. Ser langt og glider lettere gennem skovens mørke.", ulempe: "Lav start-HP. Hvis byttet svarer igen, mærkes det.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'hunter_f', navn: "Skytte", ikon: "/game_faces/hunter_f.webp", startMsg: "Hold afstand til byttet.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 1.1, goldMod: 1.0, fordel: "Bue og skarpt blik. Ser langt og glider lettere gennem skovens mørke.", ulempe: "Lav start-HP. Hvis byttet svarer igen, mærkes det.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'pirate_m', navn: "Kaptajn", ikon: "/game_faces/pirate_m.webp", startMsg: "Havet tog alt andet.", startHp: 110, startGuld: 150, startUdstyr: ['sabel', 'klude', 'hemmelighed'], moveCost: 1, digCost: 5, dmgMod: 1.0, goldMod: 1.2, fordel: "Sabel, kapital og skattekort. Havet er dyrt, men du kender prisen.", ulempe: "Ingen sovepose. Landkrabber får bedre nattesøvn.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'hav': -3, 'soe': -1 } },
    { id: 'pirate_f', navn: "Korsar", ikon: "/game_faces/pirate_f.webp", startMsg: "Havet tog alt andet.", startHp: 110, startGuld: 150, startUdstyr: ['sabel', 'klude', 'hemmelighed'], moveCost: 1, digCost: 5, dmgMod: 1.0, goldMod: 1.2, fordel: "Sabel, kapital og skattekort. Havet er dyrt, men du kender prisen.", ulempe: "Ingen sovepose. Landkrabber får bedre nattesøvn.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'hav': -3, 'soe': -1 } },
    { id: 'dwarf_m', navn: "Dværg", ikon: "/game_faces/dwarf_m.webp", startMsg: "Du graver effektivt, men bevæger dig langsomt.", startHp: 130, startGuld: 80, startUdstyr: ['skovl', 'oekse', 'klude'], moveCost: 1.5, digCost: 2, dmgMod: 1.0, goldMod: 1.3, fordel: "Skovl, økse og guldlugt. Bjergene er ikke forhindringer, de er invitationer.", ulempe: "Langsom på åbent land. Benene er korte, ambitionen ikke.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'bjerg': -3, 'krystal': -2 } },
    ...
    { id: 'orc_m', navn: "Ork", ikon: "/game_faces/orc_m.webp", startMsg: "Du starter med meget HP, kølle og lav guldindkomst.", startHp: 160, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "160 HP og kølle. Markeder og byer kan blive til ruiner og hurtige mønter.", ulempe: "Dårlig guldindkomst. Smadring koster blod, tid og handelsvenner.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'orc_f', navn: "Klanleder", ikon: "/game_faces/orc_f.webp", startMsg: "Du starter med meget HP, kølle og lav guldindkomst.", startHp: 160, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "160 HP og kølle. Markeder og byer kan blive til ruiner og hurtige mønter.", ulempe: "Dårlig guldindkomst. Smadring koster blod, tid og handelsvenner.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'joker_m', navn: "Joker", ikon: "/game_faces/joker_m.webp", startMsg: "Held er en strategi.", startHp: 50, startGuld: 1, startUdstyr: ['kniv'], moveCost: 1, digCost: 5, dmgMod: 2.0, goldMod: 1.5, fordel: "Absurd guldbonus, godt syn og markeder der betaler for showet.", ulempe: "50 HP og dobbelt skade. En genial plan kan stadig dø af et nys.", baseEnergi: 7, synsRadius: 2 },
