...
export const tilgaengeligeKarakterer: Karakter[] = [
    ...
    { id: 'thief_m', navn: "Tyv", ikon: "/game_faces/thief_m.webp", startMsg: "Hurtig, rig og klar til indbrud.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 4, dmgMod: 1.2, goldMod: 1.1, fordel: "Lovløse: Du kan bryde ind i byens tomme huse med din dirk. Du finder lidt mere guld end andre.", ulempe: "Du tager 20% mere skade og ser kun 1 felt. Det koster 4 energi at grave.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    { id: 'thief_f', navn: "Skygge", ikon: "/game_faces/thief_f.webp", startMsg: "Hurtig, rig og klar til indbrud.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 4, dmgMod: 1.2, goldMod: 1.1, fordel: "Lovløse: Du kan bryde ind i byens tomme huse med din dirk. Du finder lidt mere guld end andre.", ulempe: "Du tager 20% mere skade og ser kun 1 felt. Det koster 4 energi at grave.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    ...
    { id: 'hunter_m', navn: "Jæger", ikon: "/game_faces/hunter_m.webp", startMsg: "Ser langt og bevæger sig let i skov.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.1, goldMod: 1.0, fordel: "Spejdere: Du ser længere end de fleste. Du kan spore andre spillere, du møder.", ulempe: "Du starter med 90 HP og 20 guld og tager 10% mere skade. Gravning koster 5 energi.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'hunter_f', navn: "Skytte", ikon: "/game_faces/hunter_f.webp", startMsg: "Ser langt og bevæger sig let i skov.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.1, goldMod: 1.0, fordel: "Spejdere: Du ser længere end de fleste. Du kan spore andre spillere, du møder.", ulempe: "Du starter med 90 HP og 20 guld og tager 10% mere skade. Gravning koster 5 energi.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'pirate_m', navn: "Kaptajn", ikon: "/game_faces/pirate_m.webp", startMsg: "Tjener godt og bevæger sig let på vand.", startHp: 110, startGuld: 150, startUdstyr: ['sabel', 'klude', 'hemmelighed'], moveCost: 1, digCost: 4, dmgMod: 1.0, goldMod: 1.2, fordel: "Sørøvere: Du går i land med et skattekort og finder mere guld end andre. Med din sabel kan du overfalde andre spillere.", ulempe: "Du starter uden sovepose og ser kun 1 felt. Du må finde eller købe din heling undervejs.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'hav': -3, 'soe': -1 } },
    { id: 'pirate_f', navn: "Korsar", ikon: "/game_faces/pirate_f.webp", startMsg: "Tjener godt og bevæger sig let på vand.", startHp: 110, startGuld: 150, startUdstyr: ['sabel', 'klude', 'hemmelighed'], moveCost: 1, digCost: 4, dmgMod: 1.0, goldMod: 1.2, fordel: "Sørøvere: Du går i land med et skattekort og finder mere guld end andre. Med din sabel kan du overfalde andre spillere.", ulempe: "Du starter uden sovepose og ser kun 1 felt. Du må finde eller købe din heling undervejs.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'hav': -3, 'soe': -1 } },
    { id: 'dwarf_m', navn: "Dværg", ikon: "/game_faces/dwarf_m.webp", startMsg: "Graver billigt og trives i bjergene.", startHp: 130, startGuld: 80, startUdstyr: ['skovl', 'oekse', 'klude'], moveCost: 1.5, digCost: 2, dmgMod: 1.0, goldMod: 1.1, fordel: "Bjergfolk: Du er den bedste graver og finder lidt mere guld end andre. Du bevæger dig nemmere gennem bjerge og krystalfelter.", ulempe: "Hvert almindeligt skridt koster 1,5 energi. Du ser kun 1 felt og starter uden sovepose.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'bjerg': -3, 'krystal': -2 } },
