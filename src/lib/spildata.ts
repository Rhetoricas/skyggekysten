...
export const tilgaengeligeKarakterer: Karakter[] = [
    { id: 'knight_m', navn: "Ridder", ikon: "/game_faces/knight_m.webp", startMsg: "Rustningen tynger, men beskytter.", startHp: 120, startGuld: 0, startUdstyr: ['svaerd', 'rustning', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 0.9, goldMod: 1.0, fordel: "Starter med sværd, rustning og sovepose. Tager mindre skade og kan spille mere sikkert i kamp.", ulempe: "Rustning gør hvert skridt dyrere. Du starter uden guld.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'knight_f', navn: "Skjoldmø", ikon: "/game_faces/knight_f.webp", startMsg: "Rustningen tynger, men beskytter.", startHp: 120, startGuld: 0, startUdstyr: ['svaerd', 'rustning', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 0.9, goldMod: 1.0, fordel: "Rustning stopper nedgravede fælder. Slagmarker er billigere terræn for dig.", ulempe: "Gravning er tung. Hvis rustningen ryger, mister du også fældesikkerheden.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'magician_m', navn: "Troldmand", ikon: "/game_faces/magician_m.webp", startMsg: "Magi beskytter ikke mod mudder.", startHp: 80, startGuld: 0, startUdstyr: ['stav', 'klude', 'livseliksir', 'sovepose'], moveCost: 1, digCost: 8, dmgMod: 1.5, goldMod: 1.0, fordel: "Starter med stav. Den kan teleportere dig mod øst og hurtigere end benene kan.", ulempe: "Kun 80 HP og +50% skade. Dårlige events bliver farlige tidligt.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'krystal': -2 } },  
    { id: 'magician_f', navn: "Vølve", ikon: "/game_faces/magician_f.webp", startMsg: "Magi beskytter ikke mod mudder.", startHp: 80, startGuld: 0, startUdstyr: ['stav', 'klude', 'livseliksir', 'sovepose'], moveCost: 1, digCost: 8, dmgMod: 1.5, goldMod: 1.0, fordel: "Livseliksir og sovepose giver en ekstra chance, hvis ruten først går skævt.", ulempe: "Ingen startguld og dyr gravning. Krystaller er billigere terræn, men skaden er stadig farlig.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'krystal': -2 } },
    { id: 'thief_m', navn: "Tyv", ikon: "/game_faces/thief_m.webp", startMsg: "Hold dig i bevægelse.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.1, fordel: "Starter med dirk. Tomme byfelter kan brydes op for ekstra guld.", ulempe: "Tager +20% skade. En tyverute bør helst ikke blive en slagsrute.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    { id: 'thief_f', navn: "Skygge", ikon: "/game_faces/thief_f.webp", startMsg: "Hold dig i bevægelse.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.1, fordel: "9 energi, 50 guld og +10% guldindkomst giver en hurtig økonomisk start.", ulempe: "Banditfelter er billigere terræn, men du tager stadig +20% skade.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    { id: 'explorer_m', navn: "Opdager", ikon: "/game_faces/explorer_m.webp", startMsg: "Du kender terrænet.", startHp: 100, startGuld: 0, startUdstyr: ['skovl', 'klude', 'sovepose'], moveCost: 1, digCost: 3, dmgMod: 1.0, goldMod: 0.9, fordel: "Starter med skovl. Billig gravning gør skjult guld og rødder lettere at udnytte.", ulempe: "Ingen våben fra start. Nogle events har derfor færre gode svar.", baseEnergi: 7, synsRadius: 2, biomeMod: { 'hule': -2, 'ruin': -2 } },
    { id: 'explorer_f', navn: "Eventyrer", ikon: "/game_faces/explorer_f.webp", startMsg: "Du kender terrænet.", startHp: 100, startGuld: 0, startUdstyr: ['skovl', 'klude', 'sovepose'], moveCost: 1, digCost: 3, dmgMod: 1.0, goldMod: 0.9, fordel: "Langt syn afslører flere valg før du går. Huler og ruiner er billigere terræn.", ulempe: "-10% guldindkomst. Soveposen hjælper, men du starter uden våben.", baseEnergi: 7, synsRadius: 2, biomeMod: { 'hule': -2, 'ruin': -2 } },
    { id: 'viking_m', navn: "Viking", ikon: "/game_faces/viking_m.webp", startMsg: "Du starter stærkt, men uden sovepose.", startHp: 150, startGuld: 100, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 0.9, goldMod: 1.0, fordel: "Starter med 150 HP, 100 guld og økse. Du kan tåle at vælge hårdere løsninger.", ulempe: "Ingen sovepose. Tabt HP skal findes, købes eller vindes tilbage.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'viking_f', navn: "Valkyrie", ikon: "/game_faces/viking_f.webp", startMsg: "Du starter stærkt, men uden sovepose.", startHp: 150, startGuld: 100, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 0.9, goldMod: 1.0, fordel: "Første større skade hver dag kan give et gratis skridt. Slagmarker er billigere terræn.", ulempe: "Uden sovepose kan lange sikre pauser ikke planlægges på samme måde.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'royal_m', navn: "Hertug", ikon: "/game_faces/royal_m.webp", startMsg: "Du starter med mange penge og intet våben.", startHp: 100, startGuld: 500, startUdstyr: ['flot_toej', 'sovepose'], moveCost: 1, digCost: 10, dmgMod: 1.1, goldMod: 1.2, fordel: "Starter med 500 guld. Du kan købe strategi før andre har fundet den.", ulempe: "Ingen våben fra start. Guld løser ikke alle eventvalg.", baseEnergi: 6, synsRadius: 1 },
    { id: 'royal_f', navn: "Dronning", ikon: "/game_faces/royal_f.webp", startMsg: "Du starter med mange penge og intet våben.", startHp: 100, startGuld: 500, startUdstyr: ['flot_toej', 'sovepose'], moveCost: 1, digCost: 10, dmgMod: 1.1, goldMod: 1.2, fordel: "Fint tøj og adel giver stærk guldindkomst. Soveposen gør rigdom lettere at omsætte over tid.", ulempe: "Dyr gravning, 6 energi og +10% skade. Du er rig, ikke robust.", baseEnergi: 6, synsRadius: 1 },
    { id: 'hunter_m', navn: "Jæger", ikon: "/game_faces/hunter_m.webp", startMsg: "Hold afstand til byttet.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 1.1, goldMod: 1.0, fordel: "Starter med bue. Buevalg i events kan give bedre kontrol over risiko.", ulempe: "Kun 90 HP og +10% skade. Overmod er dyrt.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'hunter_f', navn: "Skytte", ikon: "/game_faces/hunter_f.webp", startMsg: "Hold afstand til byttet.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 1.1, goldMod: 1.0, fordel: "Syn 2, 8 energi og skovfordel gør det lettere at vælge rute før faren.", ulempe: "Lav start-HP. Hvis kampen når ind på kroppen, mærkes det.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'pirate_m', navn: "Kaptajn", ikon: "/game_faces/pirate_m.webp", startMsg: "Havet tog alt andet.", startHp: 110, startGuld: 150, startUdstyr: ['sabel', 'klude', 'hemmelighed'], moveCost: 1, digCost: 5, dmgMod: 1.0, goldMod: 1.2, fordel: "Starter med sabel, 150 guld og skattekort. Hav og søer er billigere terræn.", ulempe: "Ingen sovepose. Vand koster mindre energi, men giver stadig normal vandskade.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'hav': -3, 'soe': -1 } },
    { id: 'pirate_f', navn: "Korsar", ikon: "/game_faces/pirate_f.webp", startMsg: "Havet tog alt andet.", startHp: 110, startGuld: 150, startUdstyr: ['sabel', 'klude', 'hemmelighed'], moveCost: 1, digCost: 5, dmgMod: 1.0, goldMod: 1.2, fordel: "+20% guld gør fund, handel og skattekort mere værd, hvis du overlever ruten.", ulempe: "Uden sovepose er dårlige dage sværere at nulstille.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'hav': -3, 'soe': -1 } },
    { id: 'dwarf_m', navn: "Dværg", ikon: "/game_faces/dwarf_m.webp", startMsg: "Du graver effektivt, men bevæger dig langsomt.", startHp: 130, startGuld: 80, startUdstyr: ['skovl', 'oekse', 'klude'], moveCost: 1.5, digCost: 2, dmgMod: 1.0, goldMod: 1.25, fordel: "Starter med skovl og økse. Gravning er ekstremt billig, og guld giver +25%.", ulempe: "Hvert normalt skridt er dyrere. Åbent land æder tempo.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'bjerg': -3, 'krystal': -2 } },
    { id: 'dwarf_f', navn: "Graver", ikon: "/game_faces/dwarf_f.webp", startMsg: "Du graver effektivt, men bevæger dig langsomt.", startHp: 130, startGuld: 80, startUdstyr: ['skovl', 'oekse', 'klude'], moveCost: 1.5, digCost: 2, dmgMod: 1.0, goldMod: 1.25, fordel: "Bjerg og krystaller er billigere terræn. Gravefund passer til din økonomi.", ulempe: "Ingen sovepose. Krystaller kan stadig ødelægge værktøj.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'bjerg': -3, 'krystal': -2 } },
    { id: 'orc_m', navn: "Ork", ikon: "/game_faces/orc_m.webp", startMsg: "Du starter med meget HP, kølle og lav guldindkomst.", startHp: 160, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "Starter med 160 HP og kølle. Byer og markeder kan smadres til ruiner og kontanter.", ulempe: "-20% guld og ingen sovepose. Almindelig indkomst er svag.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'orc_f', navn: "Kriger", ikon: "/game_faces/orc_f.webp", startMsg: "Du starter med meget HP, kølle og lav guldindkomst.", startHp: 160, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "Tager mindre skade og har 8 energi. Slagmarker er billigere terræn.", ulempe: "Smadring koster HP og energi, og naboerne kan blive bange for dig.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'joker_m', navn: "Joker", ikon: "/game_faces/joker_m.webp", startMsg: "Held er en strategi.", startHp: 50, startGuld: 1, startUdstyr: ['kniv'], moveCost: 1, digCost: 5, dmgMod: 2.0, goldMod: 1.5, fordel: "Starter med langt syn og +50% guld. Hver god indtægt bliver markant bedre.", ulempe: "Kun 50 HP. Selv små fejl kan blive dødelige.", baseEnergi: 7, synsRadius: 2 },
    { id: 'joker_f', navn: "Harlekin", ikon: "/game_faces/joker_f.webp", startMsg: "Held er en strategi.", startHp: 50, startGuld: 1, startUdstyr: ['kniv'], moveCost: 1, digCost: 5, dmgMod: 2.0, goldMod: 1.5, fordel: "Kniv, højt syn og voldsom guldbonus gør risikospil meget rentable.", ulempe: "Dobbelt skade. Du skal vinde hurtigt eller vælge meget præcist.", baseEnergi: 7, synsRadius: 2 }
];
