...
export const tilgaengeligeKarakterer: Karakter[] = [
    ...
    { id: 'thief_m', navn: "Tyv", ikon: "/game_faces/thief_m.png", startMsg: "Hold dig i bevægelse.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'klude'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.0, canRest: true, fordel: "Hurtig og udstyret med en kniv.", ulempe: "Tager +20% skade.", baseEnergi: 9, synsRadius: 1, synsProfil: 'frem' },
    { id: 'thief_f', navn: "Skygge", ikon: "/game_faces/thief_f.png", startMsg: "Hold dig i bevægelse.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'klude'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.0, canRest: true, fordel: "Hurtig og udstyret med en kniv.", ulempe: "Tager +20% skade.", baseEnergi: 9, synsRadius: 1, synsProfil: 'frem' },
    { id: 'explorer_m', navn: "Udforsker", ikon: "/game_faces/explorer_m.png", startMsg: "Du kender terrænet.", startHp: 100, startGuld: 0, startUdstyr: ['skovl', 'klude'], moveCost: 1, digCost: 2, dmgMod: 1.0, goldMod: 1.0, canRest: true, fordel: "Kan se langt og starter med en spade.", ulempe: "Mangler våben fra start.", baseEnergi: 7, synsRadius: 2, synsProfil: 'cirkel' },
    { id: 'explorer_f', navn: "Eventyrer", ikon: "/game_faces/explorer_f.png", startMsg: "Du kender terrænet.", startHp: 100, startGuld: 0, startUdstyr: ['skovl', 'klude'], moveCost: 1, digCost: 2, dmgMod: 1.0, goldMod: 1.0, canRest: true, fordel: "Kan se langt og starter med en spade.", ulempe: "Mangler våben fra start.", baseEnergi: 7, synsRadius: 2, synsProfil: 'cirkel' },
    { id: 'viking_m', navn: "Viking", ikon: "/game_faces/viking_m.png", startMsg: "Hvile er for de svage.", startHp: 150, startGuld: 0, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 1.0, goldMod: 1.0, canRest: false, fordel: "Enorm HP og tung økse.", ulempe: "Nægter at slå lejr og hvile.", baseEnergi: 8, synsRadius: 1, synsProfil: 'cirkel' },
    { id: 'viking_f', navn: "Valkyrie", ikon: "/game_faces/viking_f.png", startMsg: "Hvile er for de svage.", startHp: 150, startGuld: 0, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 1.0, goldMod: 1.0, canRest: false, fordel: "Enorm HP og tung økse.", ulempe: "Nægter at slå lejr og hvile.", baseEnergi: 8, synsRadius: 1, synsProfil: 'cirkel' },
    { id: 'royal_m', navn: "Hertug", ikon: "/game_faces/royal_m.png", startMsg: "Penge løser alt.", startHp: 100, startGuld: 400, startUdstyr: ['flot_toej'], moveCost: 1, digCost: 15, dmgMod: 1.0, goldMod: 1.0, canRest: true, fordel: "Masser af guld og fint tøj (+50% indtægt).", ulempe: "Intet våben. Gravning koster mere HP.", baseEnergi: 6, synsRadius: 1, synsProfil: 'cirkel' },
    { id: 'royal_f', navn: "Hertuginde", ikon: "/game_faces/royal_f.png", startMsg: "Penge løser alt.", startHp: 100, startGuld: 400, startUdstyr: ['flot_toej'], moveCost: 1, digCost: 15, dmgMod: 1.0, goldMod: 1.0, canRest: true, fordel: "Masser af guld og fint tøj (+50% indtægt).", ulempe: "Intet våben. Gravning koster mere HP.", baseEnergi: 6, synsRadius: 1, synsProfil: 'cirkel' }
];