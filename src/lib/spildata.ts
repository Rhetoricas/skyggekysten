...
export const tilgaengeligeKarakterer: Karakter[] = [
    ...
    { id: 'dwarf_m', navn: "Dværg", ikon: "/game_faces/dwarf_m.webp", startMsg: "Du graver effektivt, men bevæger dig langsomt.", startHp: 130, startGuld: 80, startUdstyr: ['skovl', 'oekse', 'klude'], moveCost: 1.5, digCost: 2, dmgMod: 1.0, goldMod: 1.25, fordel: "Bedste graveøkonomi: skovl fra start, gravning for 2 energi og +25% guld.", ulempe: "Langsom på almindelige skridt og ingen sovepose.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'bjerg': -3, 'krystal': -2 } },
    { id: 'dwarf_f', navn: "Graver", ikon: "/game_faces/dwarf_f.webp", startMsg: "Du graver effektivt, men bevæger dig langsomt.", startHp: 130, startGuld: 80, startUdstyr: ['skovl', 'oekse', 'klude'], moveCost: 1.5, digCost: 2, dmgMod: 1.0, goldMod: 1.25, fordel: "Bjerg og krystal er billigere. Stærkest, når ruten går gennem graveområder.", ulempe: "Langsom uden for sine terræner og uden sovepose.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'bjerg': -3, 'krystal': -2 } },
