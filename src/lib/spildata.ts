...
export const tilgaengeligeKarakterer: Karakter[] = [
    { id: 'knight_m', navn: "Ridder", ikon: "/game_faces/knight_m.webp", startMsg: "Robust og godt beskyttet.", startHp: 120, startGuld: 0, startUdstyr: ['svaerd', 'rustning', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 0.9, goldMod: 1.0, fordel: "Ordenen: Du tager 10% mindre skade, mærker ikke rustningens vægt og undgår nedgravede fælder.", ulempe: "Du starter uden guld og ser kun 1 felt. Det koster 6 energi at grave, og rustningen går tabt i vand.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'knight_f', navn: "Skjoldmø", ikon: "/game_faces/knight_f.webp", startMsg: "Robust og godt beskyttet.", startHp: 120, startGuld: 0, startUdstyr: ['svaerd', 'rustning', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 0.9, goldMod: 1.0, fordel: "Ordenen: Du tager 10% mindre skade, mærker ikke rustningens vægt og undgår nedgravede fælder.", ulempe: "Du starter uden guld og ser kun 1 felt. Det koster 6 energi at grave, og rustningen går tabt i vand.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'magician_m', navn: "Troldmand", ikon: "/game_faces/magician_m.webp", startMsg: "Mobil magi med en nødplan.", startHp: 80, startGuld: 0, startUdstyr: ['stav', 'klude', 'livseliksir', 'sovepose'], moveCost: 1, digCost: 8, dmgMod: 1.5, goldMod: 1.0, fordel: "Magikere: Staven flytter dig mod øst. Krystaller heler dig og lader staven afsløre andre krystalfelter.", ulempe: "Du starter med 80 HP og uden guld, tager 50% mere skade og bruger 8 energi på at grave. Der er ikke meget plads til fejl.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'krystal': -2 } },
    ...
    { id: 'thief_m', navn: "Tyv", ikon: "/game_faces/thief_m.webp", startMsg: "Hurtig, rig og klar til indbrud.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.1, fordel: "Lovløse: Du kan bryde ind i tomme byfelter med en dirk og får 10% mere ud af alt guld.", ulempe: "Du tager 20% mere skade og ser kun 1 felt. Det koster 5 energi at grave.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    { id: 'thief_f', navn: "Skygge", ikon: "/game_faces/thief_f.webp", startMsg: "Hurtig, rig og klar til indbrud.", startHp: 100, startGuld: 50, startUdstyr: ['kniv', 'dirk', 'klude', 'sovepose'], moveCost: 1, digCost: 5, dmgMod: 1.2, goldMod: 1.1, fordel: "Lovløse: Du kan bryde ind i tomme byfelter med en dirk og får 10% mere ud af alt guld.", ulempe: "Du tager 20% mere skade og ser kun 1 felt. Det koster 5 energi at grave.", baseEnergi: 9, synsRadius: 1, biomeMod: { 'bandit': -2 } },
    ...
    { id: 'viking_m', navn: "Viking", ikon: "/game_faces/viking_m.webp", startMsg: "Stærk og sejlivet, men uden sovepose.", startHp: 140, startGuld: 100, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 0.9, goldMod: 0.9, fordel: "Nordboere: Du tager 10% mindre skade. Når du bliver såret, kan bersærkergang gøre din næste energikrævende handling gratis.", ulempe: "Du starter uden sovepose og får 10% mindre ud af alt guld. Heling skal findes eller købes undervejs.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'viking_f', navn: "Valkyrie", ikon: "/game_faces/viking_f.webp", startMsg: "Stærk og sejlivet, men uden sovepose.", startHp: 140, startGuld: 100, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 0.9, goldMod: 0.9, fordel: "Nordboere: Du tager 10% mindre skade. Når du bliver såret, kan bersærkergang gøre din næste energikrævende handling gratis.", ulempe: "Du starter uden sovepose og får 10% mindre ud af alt guld. Heling skal findes eller købes undervejs.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'royal_m', navn: "Hertug", ikon: "/game_faces/royal_m.webp", startMsg: "Rig fra start, men uden våben.", startHp: 100, startGuld: 500, startUdstyr: ['flot_toej', 'sovepose'], moveCost: 1, digCost: 10, dmgMod: 1.1, goldMod: 1.2, fordel: "Adel: Du får 20% mere guld og kan presse handlende på prisen. Når du møder andre spillere, opkræver du skat.", ulempe: "Du har kun 6 energi, tager 10% mere skade og starter uden våben. Gravning koster hele 10 energi.", baseEnergi: 6, synsRadius: 1 },
    { id: 'royal_f', navn: "Dronning", ikon: "/game_faces/royal_f.webp", startMsg: "Rig fra start, men uden våben.", startHp: 100, startGuld: 500, startUdstyr: ['flot_toej', 'sovepose'], moveCost: 1, digCost: 10, dmgMod: 1.1, goldMod: 1.2, fordel: "Adel: Du får 20% mere guld og kan presse handlende på prisen. Når du møder andre spillere, opkræver du skat.", ulempe: "Du har kun 6 energi, tager 10% mere skade og starter uden våben. Gravning koster hele 10 energi.", baseEnergi: 6, synsRadius: 1 },
    { id: 'hunter_m', navn: "Jæger", ikon: "/game_faces/hunter_m.webp", startMsg: "Ser langt og bevæger sig let i skov.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 1.1, goldMod: 1.0, fordel: "Spejdere: Du ser længere end de fleste. Når du spiller med andre, kan du spore en spiller på samme felt i 20 dage.", ulempe: "Du starter med 90 HP og 20 guld og tager 10% mere skade. Gravning koster 6 energi.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'hunter_f', navn: "Skytte", ikon: "/game_faces/hunter_f.webp", startMsg: "Ser langt og bevæger sig let i skov.", startHp: 90, startGuld: 20, startUdstyr: ['bue', 'klude', 'sovepose'], moveCost: 1, digCost: 6, dmgMod: 1.1, goldMod: 1.0, fordel: "Spejdere: Du ser længere end de fleste. Når du spiller med andre, kan du spore en spiller på samme felt i 20 dage.", ulempe: "Du starter med 90 HP og 20 guld og tager 10% mere skade. Gravning koster 6 energi.", baseEnergi: 8, synsRadius: 2, biomeMod: { 'skov': -2, 'blodskov': -2 } },
    { id: 'pirate_m', navn: "Kaptajn", ikon: "/game_faces/pirate_m.webp", startMsg: "Tjener godt og bevæger sig let på vand.", startHp: 110, startGuld: 150, startUdstyr: ['sabel', 'klude', 'hemmelighed'], moveCost: 1, digCost: 5, dmgMod: 1.0, goldMod: 1.2, fordel: "Sørøvere: Du får 20% mere guld og starter med et skattekort. Når du spiller med andre, kan sabelen bruges til at røve udvalgte klasser.", ulempe: "Du starter uden sovepose og ser kun 1 felt. Du må finde eller købe din heling undervejs.", baseEnergi: 7, synsRadius: 1, biomeMod: { 'hav': -3, 'soe': -1 } },
    ...
    { id: 'orc_m', navn: "Ork", ikon: "/game_faces/orc_m.webp", startMsg: "Tåler meget og kan smadre handelssteder.", startHp: 150, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "Klanfolk: Du tager 20% mindre skade og kan smadre byer og markeder med din kølle.", ulempe: "Du starter uden guld, tøj og sovepose og får 20% mindre ud af alt guld. Gravning koster 6 energi.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'orc_f', navn: "Kriger", ikon: "/game_faces/orc_f.webp", startMsg: "Tåler meget og kan smadre handelssteder.", startHp: 150, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "Klanfolk: Du tager 20% mindre skade og kan smadre byer og markeder med din kølle.", ulempe: "Du starter uden guld, tøj og sovepose og får 20% mindre ud af alt guld. Gravning koster 6 energi.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'joker_m', navn: "Joker", ikon: "/game_faces/joker_m.webp", startMsg: "Stor gevinst, næsten ingen fejlmargin.", startHp: 50, startGuld: 1, startUdstyr: ['kniv'], moveCost: 1, digCost: 5, dmgMod: 2.0, goldMod: 1.5, fordel: "Fantaster: Du ser længere, får 50% mere guld og kan bluffe dig gennem valg i hændelser, der kræver udstyr eller bestemte karakterer.", ulempe: "Du starter med 50 HP og 1 guld, uden tøj eller sovepose, og tager dobbelt skade. Næsten enhver fejl kan blive den sidste.", baseEnergi: 7, synsRadius: 2 },
    { id: 'joker_f', navn: "Harlekin", ikon: "/game_faces/joker_f.webp", startMsg: "Stor gevinst, næsten ingen fejlmargin.", startHp: 50, startGuld: 1, startUdstyr: ['kniv'], moveCost: 1, digCost: 5, dmgMod: 2.0, goldMod: 1.5, fordel: "Fantaster: Du ser længere, får 50% mere guld og kan bluffe dig gennem valg i hændelser, der kræver udstyr eller bestemte karakterer.", ulempe: "Du starter med 50 HP og 1 guld, uden tøj eller sovepose, og tager dobbelt skade. Næsten enhver fejl kan blive den sidste.", baseEnergi: 7, synsRadius: 2 }
];
