...
export const tilgaengeligeKarakterer: Karakter[] = [
    ...
    { id: 'explorer_f', navn: "Eventyrer", ikon: "/game_faces/explorer_f.webp", startMsg: "Du kender terrænet.", startHp: 100, startGuld: 0, startUdstyr: ['skovl', 'klude', 'sovepose'], moveCost: 1, digCost: 3, dmgMod: 1.0, goldMod: 0.9, fordel: "Syn 2 afslører flere valg før du går. Huler og ruiner er billigere terræn.", ulempe: "-10% guldindkomst. Soveposen hjælper, men du starter uden våben.", baseEnergi: 7, synsRadius: 2, biomeMod: { 'hule': -2, 'ruin': -2 } },
    ...
    { id: 'viking_f', navn: "Valkyrie", ikon: "/game_faces/viking_f.webp", startMsg: "Du starter stærkt, men uden sovepose.", startHp: 150, startGuld: 100, startUdstyr: ['oekse', 'klude'], moveCost: 1, digCost: 5, dmgMod: 0.9, goldMod: 1.0, fordel: "Første store skade hver dag kan give et gratis skridt. Slagmarker er billigere terræn.", ulempe: "Uden sovepose kan lange sikre pauser ikke planlægges på samme måde.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    ...
    { id: 'orc_f', navn: "Kriger", ikon: "/game_faces/orc_f.webp", startMsg: "Du starter med meget HP, kølle og lav guldindkomst.", startHp: 160, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "Tager mindre skade og har 8 energi. Slagmarker er billigere terræn.", ulempe: "Smadring koster HP og energi, og naboers handel lukker for dig.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'joker_m', navn: "Joker", ikon: "/game_faces/joker_m.webp", startMsg: "Held er en strategi.", startHp: 50, startGuld: 1, startUdstyr: ['kniv'], moveCost: 1, digCost: 5, dmgMod: 2.0, goldMod: 1.5, fordel: "Starter med syn 2 og +50% guld. Hver god indtægt bliver markant bedre.", ulempe: "Kun 50 HP. Selv små fejl kan blive dødelige.", baseEnergi: 7, synsRadius: 2 },
