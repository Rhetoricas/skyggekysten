...
export const tilgaengeligeKarakterer: Karakter[] = [
    ...
    { id: 'orc_m', navn: "Ork", ikon: "/game_faces/orc_m.webp", startMsg: "Du starter med meget HP, kølle og lav guldindkomst.", startHp: 160, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "Mest rå styrke: 160 HP, 20% mindre skade og kølle fra start.", ulempe: "20% mindre guldindkomst og ingen sovepose. Økonomien er svag uden smadring.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
    { id: 'orc_f', navn: "Kriger", ikon: "/game_faces/orc_f.webp", startMsg: "Du starter med meget HP, kølle og lav guldindkomst.", startHp: 160, startGuld: 0, startUdstyr: ['koelle'], moveCost: 1, digCost: 6, dmgMod: 0.8, goldMod: 0.8, fordel: "Køllen åbner for smadring. Slagmark er billigere terræn.", ulempe: "Smadring skræmmer naboers handlende. 20% mindre guldindkomst.", baseEnergi: 8, synsRadius: 1, biomeMod: { 'slagmark': -2 } },
